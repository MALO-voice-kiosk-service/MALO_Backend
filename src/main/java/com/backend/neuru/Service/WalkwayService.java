...
public class WalkwayService {
    ...
    @Transactional
    public String fetchDataAndSave(String coor_x, String coor_y) throws IOException {
        String url1 = String.format("https://map.seoul.go.kr/openapi/v5/KEY80_d205ac47ac50400588ae474e5c0f3e2b/public/themes/contents/ko?page_size=20&page_no=1&coord_x=%s&coord_y=%s&distance=2000&search_type=0&search_name=&theme_id=11102801", coor_x,  coor_y);
        ...
        for (JsonNode node : bodyArray) {
            ...
            if(standard != null){
                ...
                if(walkwayJSONEntity.isPresent()){
                    ...
                    walkwayEntity.setCity(null);
                    walkwayEntity.setKeyword(0);
